                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (checkOut) {
                                                    ...
                                                    const [newCheckInYear, newCheckInMonth, newCheckInDay] = e.target.value.split('-');
                                                    const [checkOutYear, checkOutMonth, checkOutDay] = checkOut.split('-');
                                                    
                                                    const newCheckInDate = new Date(parseInt(newCheckInYear), parseInt(newCheckInMonth) - 1, parseInt(newCheckInDay));
                                                    const currentCheckOutDate = new Date(parseInt(checkOutYear), parseInt(checkOutMonth) - 1, parseInt(checkOutDay));
                                                    ...
                                                    if (currentCheckOutDate <= newCheckInDate) {
                                                        ...
                                                        const month = String(newCheckOutDate.getMonth() + 1).padStart(2, '0');
                                                        const day = String(newCheckOutDate.getDate()).padStart(2, '0');
                    ...
                    {showDatePrompt ? (
                        <div className="text-center py-12 sm:py-16 bg-gray-50 rounded-lg mx-4 sm:mx-0">
                            ...
                            <p className="text-gray-600 mb-6 px-4">
                                Pilih tanggal check-in dan check-out di form di atas untuk melihat apartemen yang tersedia
                            </p>
                            <div className="flex justify-center px-4">
                                <button
                                    onClick={() => {
                                        ...
                                        setCheckOut(`${tomorrowYear}-${tomorrowMonth}-${tomorrowDay}`);
                                        setShowDatePrompt(false);
