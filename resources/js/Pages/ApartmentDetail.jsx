              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-gray-600">
                  <div className="flex items-center gap-1">
                    ...
                    <span>({apartmentData.reviewCount || 0} ulasan)</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <MapPin size={16} />
                    <span>{apartmentData.location || "Yogyakarta"}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-6 sm:space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-2 text-gray-700">
                    <Bath size={20} />
                    <span className="text-sm">
                      {apartmentData.bathrooms} Kamar Mandi
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-700">
                    <Users size={20} />
                    <span className="text-sm">Max 4 Orang</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-700">
                    <Home size={20} />
                    <span className="text-sm">{apartmentData.area} m²</span>
                  </div>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-black">Ulasan Tamu</h2>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-600">
                      ({(apartmentData.reviews || []).length} ulasan)
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <button className="text-black font-medium hover:underline">
                    Lihat semua {(apartmentData.reviews || []).length} ulasan
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm sticky top-32">
                <div className="text-center mb-6">
                  <div className="text-2xl font-bold text-black">
                    {formatPrice(apartmentData.price) || "Rp 450.000"}
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <div className="flex justify-between items-center text-sm text-gray-600 mb-2">
                    ...
                    <span>{formatPrice(apartmentData.price)}</span>
                  </div>
                  {calculateNights() > 0 && (
                    <div className="flex justify-between items-center text-sm text-gray-600 mb-2">
                  ...
                  {calculateNights() > 0 && (
                    <div className="flex justify-between items-center text-sm text-gray-600 mb-2">
                      <span>Subtotal</span>
                      <span>
                        {formatPrice(calculateNights() * apartmentData.price)}
                      </span>
                    </div>
                  )}
                  <div className="flex justify-between items-center text-sm text-gray-600 mb-2">
                  ...
                  <div className="flex justify-between items-center font-semibold text-black pt-2 border-t border-gray-200">
                    ...
                    <span>
                      {calculateNights() > 0
                        ...
                        : formatPrice((apartmentData.price || 450000) + 25000)}
                    </span>
                  </div>
                </div>
              </div>
